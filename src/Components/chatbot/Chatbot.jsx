...
export default function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      {isOpen && (
        <div className="absolute bottom-16 right-0 w-96 h-[500px] bg-gradient-to-b from-[#1a1f2c] to-[#0d1117] rounded-lg shadow-xl flex flex-col border border-gray-700">
          ...
          <div className="p-4 bg-gradient-to-r from-purple-900 to-[#1a1f2c] rounded-t-lg border-b border-gray-700">
            ...
            <p className="text-gray-300 text-sm">Ask me about movies and TV shows</p>
          </div>
